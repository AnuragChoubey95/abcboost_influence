...
def plot_composite_bar_chart(avg_boostin, avg_lca, out_file="composite_removal_bars.png"):
    """
    ...
    ax.set_title("Composite Single-Test Removal Results")
...
def main():
    ...
    plot_composite_bar_chart(avg_boostin, avg_lca, out_file="charts/composite_removal_bars.png")
